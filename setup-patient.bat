@echo off
REM Hair Loss Diagnosis and Treatment Platform - Patient Frontend Setup Script (Windows)

echo.
echo === Patient Frontend Setup Started ===
echo ==========================================
echo.

REM Check if we're in the project root directory
if not exist "frontend\patient" (
    echo [ERROR] frontend\patient directory not found. Please run this script from the project root directory.
    pause
    exit /b 1
)

REM Change to patient frontend directory
cd frontend\patient
...
if not exist "package.json" (
    echo [ERROR] package.json not found in frontend\patient directory
    pause
    exit /b 1
)
...
if not exist ".env" (
    ...
    (
        ...
        echo REACT_APP_APP_NAME=Hair Skin Health - Patient Portal
...
echo.
echo ==========================================
echo [SUCCESS] Patient frontend setup completed successfully!
echo ==========================================
echo.
