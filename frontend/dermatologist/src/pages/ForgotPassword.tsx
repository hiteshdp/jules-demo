      ...
      >
        <div className="text-center">
          <motion.div
            ...
            className="mx-auto h-12 w-12 bg-gradient-to-r from-green-500 to-teal-600 rounded-full flex items-center justify-center"
          >
            ...
            >
              ...
              <Form.Item>
                <Button
                  ...
                  htmlType="submit"
                  loading={loading}
                  className="w-full h-12 bg-gradient-to-r from-green-500 to-teal-600 border-0 rounded-lg font-semibold text-lg hover:from-green-600 hover:to-teal-700"
                >
