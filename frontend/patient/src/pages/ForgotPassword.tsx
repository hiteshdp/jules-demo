      ...
      >
        <div className="text-center">
          <motion.div
            ...
            className="mx-auto h-12 w-12 bg-gradient-to-r from-blue-500 to-purple-600 rounded-full flex items-center justify-center"
          >
            ...
            >
              ...
              <Form.Item>
                <Button
                  ...
                  htmlType="submit"
                  loading={loading}
                  className="w-full h-12 bg-gradient-to-r from-blue-500 to-purple-600 border-0 rounded-lg font-semibold text-lg hover:from-blue-600 hover:to-purple-700"
                >
            ...
            >
              ...
              <Form.Item>
                <Button
                  ...
                  htmlType="submit"
                  loading={loading}
                  className="w-full h-12 bg-gradient-to-r from-green-500 to-blue-600 border-0 rounded-lg font-semibold text-lg hover:from-green-600 hover:to-blue-700"
                >
